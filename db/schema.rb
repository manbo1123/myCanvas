...
ActiveRecord::Schema.define(version: 20200926072819) do
  ...
  create_table "imgs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "src"
    t.integer  "post_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id"], name: "index_imgs_on_post_id", using: :btree
  end
